(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'Set as Default Magnet Link Downloader': 'Set as Default Magnet Link Downloader',
            'True (Not the system\'s default downloader)': 'True (Not the system\'s default downloader)',
            'Default Magnet Link Downloader': 'Default Magnet Link Downloader',
            'AriaNg Native settings have been enabled, but it is not currently set as the system\'s default magnet link downloader. Please open your system settings to complete the setup.': 'AriaNg Native settings have been enabled, but it is not currently set as the system\'s default magnet link downloader. Please open your system settings to complete the setup.',
            'Open System Settings': 'Open System Settings',
            'This feature is not supported on your system.': 'This feature is not supported on your system.',
            'Failed to open system settings.': 'Failed to open system settings.',
            ...
            'Download Info Box': 'Download Info Box',
            'Info Box Opacity': 'Info Box Opacity',
            'infobox.Active': 'Active',
            'infobox.Waiting': 'Wait',
            'infobox.Completed': 'Done',
